	...
	project "bittrex_api_test"
		...
		pchheader	"stdafx.h"
		pchsource	"tests/bittrex_api_test/stdafx.cpp"
		files {
			"sdk/include/**.h",
			"src/dataconnector/bittrex.h", "src/dataconnector/bittrex.cpp",
	...
	project "connection_interface_test"
		...
		includedirs {
			...
			"samples/utils",
			"src/dataconnector",
			"tests/connection_interface_test",
			"deps/poco/Net/include",
			"deps/poco/Crypto/include",
			"deps/poco/Foundation/include",
			"deps/poco/Util/include",
		...
		pchheader	"stdafx.h"
		pchsource	"tests/connection_interface_test/stdafx.cpp"
		files {
			"sdk/include/**.h",
			"src/dataconnector/*",
			"tests/connection_interface_test/**.h", "tests/connection_interface_test/**.cpp",
			"samples/utils/*",
			"include/**.h",
			"tmp/%{cfg.platform}/codegen/interface*.h", "tmp/%{cfg.platform}/codegen/interface*.cpp",
			"tmp/%{cfg.platform}/codegen/generic*.h", "tmp/%{cfg.platform}/codegen/generic*.cpp",
