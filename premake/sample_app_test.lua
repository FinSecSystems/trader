project "sample_app_test"
	...
	includedirs {
		...
		"%{wks.location}/tests/sample_app_test",
		"%{wks.location}/tmp/%{cfg.platform}/codegen",
		"%{wks.location}/deps/tinyfsm/include",
	}
	pchheader	"stdafx.h"
	pchsource	"%{wks.location}/tests/sample_app_test/stdafx.cpp"
	files {
		...
		"%{wks.location}/tests/sample_app_test/**.h",
		"%{wks.location}/tests/sample_app_test/**.cpp",
